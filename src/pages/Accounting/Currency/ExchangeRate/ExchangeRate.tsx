...
} from "../../../../api/Accounting/services/exchangeRateService";
import type { ICurrency } from "../../../../api/Accounting/types/currency.interface";
import type { IExchangeRate } from "../../../../api/Accounting/types/exchageRate.interface";
...
const ExchangeRate: React.FC = () => {
  ...
  const [exchangRate, setExchangRate] = useState<IExchangeRate[]>([]);
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    if (exchangRate.some((item) => item.tanggal === selectedTanggal)) {
      toast.error("Tidak boleh ada tanggal yang sama!");
      setIsModalWarningOpen(false);
      setErrorTanggal("Tanggal sudah ada!");
      return;
    }
  ...
  const getExchangeRate = (
    ...
    const params = {
      ...
      page,
      per_page: pageSize,
      tanggal: getValuesForm("tanggal_search")?.replace(/,/g, "") || "",
