...
const basePath = "/accounting/closing_adjustment_journal";

export const getClosingAdjustJournal = async (params?: any) => {
  if (params) {
...
export const getClosingAdjustJournalById = async (id: string) => {
  return await axiosInstance.get(`${basePath}/${id}`);
};

export const addClosingAdjustJournal = async (data: {
...
export const editClosingAdjustJournal = async (data: {
  id: any;
...
export const deleteClosingAdjustJournal = async (id: string) => {
