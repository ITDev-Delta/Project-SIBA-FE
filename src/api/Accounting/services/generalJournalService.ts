...
const basePath = "/accounting/general_journal";

export const getGeneralJournal = async (params?: any) => {
  if (params) {
...
export const getGeneralJournalById = async (id: string) => {
  return await axiosInstance.get(`${basePath}/${id}`);
};

export const addGeneralJournal = async (data: {
...
export const editGeneralJournal = async (data: {
  id: any;
